    ...
    public void postEvent(Event event) {
        ...
        if (addEventValidate()) {
            ...
            if (diffHours>=0 && diffHours <= 6.5 ) {
                ...
                if(diffHours<=1.5){
                     ans = postRequestHashMap("http://"+ipServer+"/api/referee/addEventDuringGame", hashDetails);

                }else{
                    ans = postRequestHashMap("http://"+ipServer+"/api/referee/addEventAfterGame", hashDetails);
                }
